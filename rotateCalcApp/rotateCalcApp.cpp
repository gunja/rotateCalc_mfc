...
// rotateCalcApp.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CrotateCalcAppApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CrotateCalcAppApp

CrotateCalcAppApp::CrotateCalcAppApp()
{
...
// Единственный объект CrotateCalcAppApp

CrotateCalcAppApp theApp;


// Инициализация CrotateCalcAppApp

BOOL CrotateCalcAppApp::InitInstance()
{
